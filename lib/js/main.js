...
core.createArchetype(ARCHETYPE.HERO);
core.createArchetype(ARCHETYPE.ITEM);
core.createArchetype(ARCHETYPE.ENEMY, 300, 200);
...
core.createArchetype(ARCHETYPE.WALL, WIDTH * 0.5, HEIGHT * 0.5, 64, 64, Math.PI * 0.25);
